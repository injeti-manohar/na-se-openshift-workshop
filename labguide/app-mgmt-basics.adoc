...
curl -skL -o projects.tar.gz https://github.com/cricci82/cloud-native-labs/archive/ocp-3.10.tar.gz
...
credentials. Go to your `cloud-native-labs` repository web interface and refresh
